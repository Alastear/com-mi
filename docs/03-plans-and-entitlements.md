...
| Custom handle | ✅ | ✅ | ✅ |
| ผลงานใน portfolio | 30 ชิ้น | 300 ชิ้น | ไม่จำกัด |
...
| **อื่น ๆ** | | | |
| พื้นที่เก็บไฟล์ | **2 GB** | **20 GB** | 100 GB |
| ขนาดไฟล์ต่อชิ้น | 50 MB | 200 MB | 500 MB |
...
| storage | **2 GB** | ขยับจาก 300 MB ตอนรองรับวิดีโอ — คลิป 1080p หนึ่งนาที 15–40 MB ทำให้ 300 MB เต็มด้วยคลิปสามสี่อัน คิดจากต้นทุนจริงแล้ว **egress คือค่าใช้จ่าย ไม่ใช่พื้นที่เก็บ** (ใช้เต็ม 2 GB = ค่าเก็บ ~฿1.6/เดือน) และร้านที่คนดูเยอะจนค่า egress สูงคือร้านที่พร้อมอัปเกรด — ต้นทุนปรับตัวเอง |
