...
- [ ] 🔴 **มัดจำเป็นฟิลด์จริง และห้าม `accepted → in_progress` ถ้ายังไม่จ่าย**
      TOS ตั้งต้นของเราเองเขียนว่า "ชำระมัดจำ 50% ก่อนเริ่มงาน" แต่ state machine
      ปล่อยให้เริ่มงานที่ ฿0 ได้ — ครีเอเตอร์ลงมือแล้วโดนเท
