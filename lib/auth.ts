...
/**
 * เส้นทางที่กระทำอะไรบางอย่าง "ในนามของอีเมลหนึ่ง" — ทุกเส้นต้องผ่านลิมิตต่ออีเมล
 *
 * ⚠️ `/sign-up/email` อยู่ในนี้ด้วยทั้งที่ไม่ได้ส่งรหัสอะไรออกไป
 *
 * ยิงตรงเข้ามาได้โดยไม่ต้องล็อกอิน และสร้างแถวผู้ใช้ที่ `emailVerified: false`
 * ให้อีเมลของคนอื่นได้ทันที (ทดสอบบน production แล้วได้ 200 กลับมาจริง)
 * แถวนั้นทำให้เจ้าของอีเมลตัวจริงล็อกอินด้วย Google ไม่ได้ จนกว่าจะยืนยันอีเมลก่อน
 * เพราะการผูกบัญชีต้องการอีเมลที่ยืนยันแล้ว — กู้ได้ด้วยการขอรหัสทางอีเมล
 * แต่ไม่ควรมีใครทำให้คนอื่นต้องมากู้ตั้งแต่แรก และไม่ควรทำได้ทีละพันครั้ง
 */
