...
export const media = pgTable(
  "media",
  {
    ...
    /**
     * จุดที่เจ้าของรูปอยากให้เห็น เป็นเปอร์เซ็นต์ 0–100 ของความกว้าง/สูง
     *
     * ⚠️ **เก็บตำแหน่ง ไม่ใช่ครอปรูปทิ้ง** — แบนเนอร์แสดงคนละความสูงในแต่ละขนาดจอ
     * (h-40 บนมือถือ → h-60 บนจอใหญ่) ครอปตายตัวที่สัดส่วนเดียวจึงยังเพี้ยนอยู่ดี
     * พอเก็บเป็นจุด แล้วให้ `object-position` ยึดจุดนั้น ทุกความสูงจะเห็นส่วนที่ตั้งใจ
     * และแก้ทีหลังได้โดยไม่ต้องอัปรูปใหม่ ซึ่งครอปแบบทำลายทำไม่ได้
     *
     * `null` = ยังไม่เคยตั้ง ให้ใช้กึ่งกลางตามค่าเริ่มต้นของ `object-cover`
     */
