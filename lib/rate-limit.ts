...
export const LIMITS = {
  ...
  /**
   * ออกใบเสนอราคา: 20 ครั้งต่อชั่วโมง
   *
   * ทุก action ที่สร้างแถวใหม่มีตัวจำกัด ยกเว้นตัวนี้ตอนเขียนครั้งแรก —
   * ออกใบหนึ่งครั้งได้ทั้งแถวใบ แถว event ในเธรด และแจ้งเตือนหาลูกค้า
   * ทั้งสามอย่างไม่มีใครลบได้ และหน้าออเดอร์โหลดเธรดทั้งหมดโดยไม่แบ่งหน้า
   */
  issueQuote: { limit: 20, windowSeconds: 3600 },
  /** ออกใบเชิญลูกค้า: 20 ครั้งต่อชั่วโมง — ทุกใบส่งอีเมลของคนอื่นเข้าระบบ */
  createInvite: { limit: 20, windowSeconds: 3600 },
