 ...
 *
 * ⚠️ **ถ้าไฟล์นี้ผิด เงินของคนอื่นจะไปผิดบัญชีจริง** แก้แล้วต้องรัน `pnpm test`
 * และต้องมีคนสแกน QR ด้วยแอปธนาคารจริงเพื่อดูว่าชื่อผู้รับถูกต้องก่อนปล่อยใช้งาน
 * เทสต์ยืนยันได้แค่ว่า "สร้างสตริงตามสเปก" ไม่ได้ยืนยันว่า "ธนาคารอ่านแล้วตรงคน"
 *
